...
ALARMS_ADMIN_PASSWORD="${ALARMS_ADMIN_NAME}${PASSWORD_SUFFIX}"
ALARMS_POLICY_ADMIN_NAME=alarms-policy-admin
ALARMS_POLICY_ADMIN_PASSWORD="${ALARMS_POLICY_ADMIN_NAME}${PASSWORD_SUFFIX}"
ALARMS_USER_NAME=alarms-user
ALARMS_USER_PASSWORD="${ALARMS_USER_NAME}${PASSWORD_SUFFIX}"
